...
const mockOrders: Order[] = [
  {
    ...
    total: 29.74,
    items: [
      { id: 'p1', name: 'Shiny Hat', qty: 1, price: 19.99 },
      { id: 'p3', name: 'Sticker Pack', qty: 1, price: 9.75 },
    ]
  },
  {
    id: 'o2',
    ...
    total: 49.50,
    items: [
      { id: 'p2', name: 'Puffer Jacket', qty: 1, price: 49.50 },
    ]
  },
  {
    id: 'o3',
    ...
    total: 99.99,
    items: [
      { id: 'p4', name: 'Premium Jacket', qty: 1, price: 99.99 },
    ]
  },
];
